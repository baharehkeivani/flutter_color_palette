        ...
        child: ListView(
          ...
          children: [
            ...
            ..._shadingTypes(_currentColorType).map((Map<Color, String> color) {
              final Color tempColor = color.keys.first;
              return GestureDetector(
                onTap: () {
                  setState(() => _currentShading = tempColor);
                ...
                child: Container(
                  ...
                  child: Align(
                    child: AnimatedContainer(
                      ...
                      width:
                      isPortrait ? (_currentShading == tempColor ? 250 : 230) : (_currentShading == tempColor ? 50 : 30),
                      height: isPortrait ? 50 : 220,
                      decoration: BoxDecoration(
                        color: tempColor,
                        boxShadow: _currentShading == tempColor
                            ? [
                          (tempColor == Colors.white) || (tempColor == Colors.black)
                              ? BoxShadow(
                            color: (Theme.of(context).brightness == Brightness.light) ? Colors.grey[300]! : Colors.black38,
                            blurRadius: 10,
                          )
                            ...
                            : null,
                        border: (tempColor == Colors.white) || (tempColor == Colors.black)
                            ? Border.all(color: (Theme.of(context).brightness == Brightness.light) ? Colors.grey[300]! : Colors.black38, width: 1)
                            : null,
                      ),
                      child: widget.enableLabel
                        ...
                        children: [
                          Text(
                            '  ${color.values.first}',
                            style: TextStyle(color: useWhiteForeground(tempColor) ? Colors.white : Colors.black),
                          ),
                          Expanded(
                            child: Align(
                              alignment: Alignment.centerRight,
                              child: Text(
                                '#${(tempColor.toString().replaceFirst('Color(0xff', '').replaceFirst(')', '')).toUpperCase()}  ',
                                style: TextStyle(
                                  color: useWhiteForeground(tempColor) ? Colors.white : Colors.black,
                          ...
                          : AnimatedOpacity(
                        duration: const Duration(milliseconds: 300),
                        opacity: _currentShading == tempColor ? 1 : 0,
                        child: Container(
